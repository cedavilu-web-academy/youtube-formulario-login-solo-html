<h1>Código HTML para crear un formulario de login, con input animados, utilizando las nuevas tendencias en el Diseño Web</h1>
<h2>Modo oscuro - Animaciones de elementos</h2>
<br>
